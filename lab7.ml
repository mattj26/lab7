...
populated by creatures of gemometric shapes
...
....................................................................*)
let r = new rect (1., 1.) 4. 5.
let c = new circle (0., -4.) 10.
let s = new square (-3., -2.5) 2.15
let s_list = [r; c; s] ;;
...
object
  ...
  method scale (k : float) : unit =
  let xc1, yc1 = super#center in
  super#scale k;
  let xc2, yc2 = super#center in
  super#translate (xc1 -. xc2, yc1 -. yc2);
...
that implements a quad class type. Hint: you should only need to
...
let sq : quad = new square_quad (2., 5.) 4.
